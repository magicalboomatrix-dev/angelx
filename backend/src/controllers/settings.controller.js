...
exports.getLimits = async (req, res) => {
  try {
    const settings = await prisma.systemSetting.findMany({
      where: {
        key: { in: ['usdt_rate', 'cmd_rate', 'imps_rate', 'min_deposit', 'min_withdrawal', 'min_sell', 'min_cmd', 'min_imps', 'support_link'] },
      },
    });
    ...
    return res.json({
      ...
      supportLink: settingsMap.support_link || 'https://wa.me/+917056254884',
    });
  } catch (err) {
